...
public class searchmobile implements ActionListener
{
	JFrame fr,fn;
	...
	public searchmobile(JFrame fx)
	{
		...
		fr.setContentPane(new JLabel(new ImageIcon("images/searchmobileform.png")));
		fr.setLayout(null);
